...
-- A null period is the continuous-class curriculum scope. Explicit period IDs
-- and names remain supported for API compatibility and historical workflows.
create or replace function public.get_academic_curriculum_page_v1(
  p_filters jsonb,
