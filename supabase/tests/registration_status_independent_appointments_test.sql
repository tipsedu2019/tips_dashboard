...
select has_function('public', 'save_registration_consultation_details_v1', array['uuid', 'text', 'text', 'text']);
...
select function_privs_are('public', 'save_registration_consultation_details_v1', array['uuid', 'text', 'text', 'text'], 'authenticated', array['EXECUTE']);
select is_empty($$
...
select has_column('public', 'ops_registration_subject_tracks', 'workflow_status');
