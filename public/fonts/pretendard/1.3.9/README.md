...
- Total font assets:2,957,724 bytes. Individual assets:8,252–43,920 bytes. Local CSS:57,232 bytes uncompressed. Total stored size is not a page's transfer size.
