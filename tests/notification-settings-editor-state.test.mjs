...
test("settings links preserve workflow, channel and group while rejecting retired or unknown state", () => {
  ...
  assert.deepEqual(readNotificationSettingsLocation(new URLSearchParams("workflow=word_retests&section=unknown&group=unknown")), { workflow: "registration", section: "rules", group: null })
