...
import { createRegistrationCustomerMessageBundleCatalog } from "../src/features/tasks/server/registration-customer-message-bundle-catalog.ts"
...
test("bundle resolver renders public reservation facts without private delivery fields", async () => {
  const resolver = createRegistrationCustomerMessageBundleSourceResolver({
    catalog: createRegistrationCustomerMessageBundleCatalog({}),
