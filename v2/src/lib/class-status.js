...
export const LEGACY_RUNNING_CLASS_STATUS = "수업 진행 중";
export const LEGACY_PREPARING_CLASS_STATUS = "개강 준비 중";

export const ACTIVE_CLASS_STATUS = "수강";
export const PREPARING_CLASS_STATUS = "개강 준비";
...
export function normalizeClassStatus(value) {
  ...
  if (text === LEGACY_ACTIVE_CLASS_STATUS || text === LEGACY_RUNNING_CLASS_STATUS) {
    return ACTIVE_CLASS_STATUS;
  }

  if (text === LEGACY_UPCOMING_CLASS_STATUS || text === LEGACY_PREPARING_CLASS_STATUS) {
