...
| Tasks/retests/registration/transfer/withdrawal | Numbered read model (`ebde2adb`, `31b3c2b1`) and route integration (`a19920d4`, `0329233b`) reviewed | Task3 selected regression **942/942**; TypeScript pass; focused lint 0 errors/3 legacy warnings | Isolated final-only **613/613** plus baseline/catalog **1937/1937**; required `20260831031913_ops_task_numbered_pages.sql` final hash retained | Browser-policy blocked; remote RPC/deployment pending |
