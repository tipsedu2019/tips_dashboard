...
(out/'task9-final-definitions-acl.json').write_text(json.dumps(json.loads(sql('tips_timetable_20260923_replay',q)),ensure_ascii=False,indent=2))
...
(out/'task9-manual-preservation.json').write_text(json.dumps({'verifiedUnchanged':True,'items':actual},indent=2))
