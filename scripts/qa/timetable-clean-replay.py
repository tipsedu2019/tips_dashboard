...
docker='/Users/hyunjun/.local/bin/docker';name=args.container
...
with (base/(args.prefix+'-clean-replay.log')).open('w') as log:
 ...
 for i,f in enumerate(files):
  ...
  if r.returncode:
   print('FAILED',i+1,len(files),f); print((base/(args.prefix+'-clean-replay.log')).read_text()[-2200:]);sys.exit(r.returncode)
