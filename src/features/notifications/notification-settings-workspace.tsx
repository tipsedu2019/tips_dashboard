    ...
    return (
      <Card className="mx-auto w-full max-w-2xl">
        <CardHeader>
          ...
          <CardTitle>Google Chat 알림 설정이 아직 준비되지 않았습니다</CardTitle>
          <CardDescription>
            서버 설정과 런타임 버전이 모두 확인되면 이 화면에서 업무별 Google Chat 알림을 관리할 수 있습니다.
          </CardDescription>
        </CardHeader>
        <CardContent>
    ...
    return (
      <Card className="mx-auto w-full max-w-2xl">
        <CardHeader>
          ...
          <CardTitle>Google Chat 설정 준비 상태를 확인할 수 없습니다</CardTitle>
          <CardDescription>
