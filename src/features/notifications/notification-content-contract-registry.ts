...
const VARIABLE_BY_TOKEN = Object.freeze({
  ...
  강의실: variable("classroom", "location"),
  교재: variable("textbooks"),
  진도: variable("progress"),
  제출자: variable("submitted_by_name", "staff_name"),
  제출시각: variable("submitted_at", "schedule"),
...
const EVENT_SPECS = Object.freeze({
  ...
  "registration.observation_scheduled": spec(["학생", "과목", "수업", "일정", "담당선생님", "강의실", "교재", "진도"], { mustHaveFacts: ["target", "event", "schedule", "location"], supportedPayloadVersions: [3] }),
  "registration.observation_rescheduled": spec(["학생", "과목", "수업", "기존일정", "일정", "담당선생님", "강의실", "교재", "진도"], { mustHaveFacts: ["target", "event", "before_after", "schedule", "location"], supportedPayloadVersions: [3] }),
  "registration.observation_canceled": spec(["학생", "과목", "수업", "일정"], { mustHaveFacts: ["target", "event", "current_state", "schedule"], supportedPayloadVersions: [3] }),
  "registration.observation_reminder_due": spec(["학생", "과목", "수업", "일정", "담당선생님", "강의실", "교재", "진도"], { mustHaveFacts: ["target", "event", "schedule", "location"], supportedPayloadVersions: [3] }),
  "registration.observation_feedback_due": spec(["학생", "과목", "수업", "일정", "담당선생님", "강의실"], { mustHaveFacts: ["target", "event", "schedule", "location"], supportedPayloadVersions: [3] }),
  "registration.observation_feedback_submitted": spec(["학생", "과목", "수업", "제출자", "제출시각"], { mustHaveFacts: ["target", "event", "progress_actor", "schedule"], supportedPayloadVersions: [3] }),
  "registration.observation_director_reassigned": spec(["학생", "과목", "수업"], { mustHaveFacts: ["target", "event", "current_state"], supportedPayloadVersions: [3] }),
